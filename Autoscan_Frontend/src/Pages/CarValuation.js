                  ...
                  <div className="grid">
                    <div className="form__group field">
                      <select
                        ...
                        required
                      >
                        <option value="" disabled selected class="form__label">
                          Select Make Year
                        </option>
                    ...
                    <div className="form__group field">
                      <input
                        ...
                        required
                      />
                      <label htmlFor="BrandName" class="form__label">
                        Enter Brand Name
                      </label>
                    </div>
                    <div className="form__group field">
                      ...
                      <label htmlFor="SelYear2" class="form__label">
                        Make Year
                      </label>
                    </div>
                    <div className="form__group field">
                      <input
                        ...
                        required
                      />
                      <label htmlFor="RtoCity" class="form__label">
                        RTO City
                      </label>
                    </div>
                    <div className="form__group field">
                    ...
                    <div className="form__group field">
                      <input
                        ...
                        required
                      />
                      <label htmlFor="KmRunning" class="form__label">
                    ...
                    <div className="form__group field ownership-Fields d-flex">
                      ...
                      <div className="checkboxbutton">
                        ...
                        <label className="btn btn-default" htmlFor="Owner">
                          1st Owner
                        </label>
                      </div>
                      <div className="checkboxbutton">
                    ...
                    <div className="form__group field ">
                      <button type="button" class="btn theme-btn next-step">
                        CHECK PRICE
                      </button>
                    </div>
                  </div>
