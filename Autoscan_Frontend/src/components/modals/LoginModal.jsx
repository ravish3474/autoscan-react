                    ...
                    <div className="modal-body">
                        ...
                        <form id="loginForm" onSubmit={onSubmit}>
                            <div className="form__group field">
                                ...
                                />
                                <label htmlFor="username" className="form__label">Email ID</label>
                                {userError && <p className="error-message validationMessage">{userError}</p>}
                            </div>
                            <div className="form__group field">
                                <input
                                ...
                                />
                                <a href="#" className="s-anchor togglePassword" onClick={togglePasswordVisibility}>
                            ...
                            <div className="form-footer">
                                <button type="submit" id="LoginSubmitButton" className="button" disabled={buttonLoading}>
                                    {buttonLoading ? "Signing In..." : "SIGN IN"}
                                </button>
                                <Link to="/profile" className="text-center loginFromAnother" onClick={onClose} type="button" data-dismiss="modal" aria-label="Close">
